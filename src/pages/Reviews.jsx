...
const fallbackReviews = [
  {
    ...
    image: '/images/products/globe_front.jpeg',
  },
  {
    id: 2,
    name: 'Rahul M.',
    ...
    image: '/images/products/model1_raw.jpeg',
  },
  {
    id: 3,
    name: 'Ankit D.',
    ...
    product: 'Name Plate',
    image: '/images/products/globe_back.jpeg',
  },
  {
    id: 4,
    name: 'Neha & Karan',
  ...
  },
  {
    ...
    product: '3D Face Miniature',
    image: '/images/products/model1_raw_generated.jpeg',
  },
];
    ...
    <main className="py-12 sm:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-text-secondary text-sm">Based on {reviews.length > 0 ? reviews.length + '+' : '5000+'} reviews</p>
        </motion.div>
            ...
            {reviews.map((review, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-muted text-xs">{review.location || 'India'}</p>
                    </div>
                  </div>
                  <div className="flex">
                ...
                <p className="text-text-secondary text-sm leading-relaxed mb-4">
                  "{review.text || review.content || review.review_text || ''}"
                </p>
                <div className="flex items-center gap-3 pt-4 border-t border-border-subtle">
                  {review.image && (
                    <img
                      src={review.image}
                      alt={review.product || 'Product'}
                  ...
                  <div>
                    ...
                    <p className="text-text-primary text-sm font-medium">{review.product || 'Product'}</p>
                  </div>
                </div>
              </motion.div>
            ))}
