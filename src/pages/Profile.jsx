    ...
    return (
      <main className="py-16 sm:py-24 flex flex-col items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <Link to="/login" className="bg-white hover:bg-neutral-200 text-black px-6 py-3 rounded-full font-semibold transition-all">
            Sign In
          </Link>
        </div>
      </main>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-1 space-y-4">
            ...
            <div className="card p-6 text-center">
              <div className="relative w-20 h-20 mx-auto mb-4">
                {profile?.avatar_url ? (
                  ...
                  <div className="w-20 h-20 bg-neutral-800 rounded-full flex items-center justify-center border-2 border-white/20">
                ...
                <label
                  ...
                  className="absolute -bottom-1 -right-1 w-7 h-7 bg-white rounded-full flex items-center justify-center cursor-pointer hover:opacity-90 transition-all"
                  title="Change avatar"
                >
                  {avatarUploading ? (
              ...
              {isAdmin && (
                <div className="mt-2 inline-flex items-center gap-1 px-2 py-0.5 bg-neutral-900 text-white border border-neutral-800 text-[10px] font-bold uppercase tracking-wide rounded-full">
            ...
            <div className="card overflow-hidden">
              <Link to="/orders" className="flex items-center gap-3 px-4 py-3 text-text-secondary hover:text-text-primary hover:bg-neutral-900 transition-colors">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="flex items-center gap-1.5 bg-neutral-900 hover:border-white text-white border border-neutral-800 text-sm font-medium px-4 py-1.5 rounded-full transition-all hover:-translate-y-0.5 disabled:opacity-60"
                  >
                  ...
                  {editing ? (
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-neutral-900 border border-neutral-800 rounded-xl pl-9 pr-4 py-2.5 text-text-primary text-sm focus:outline-none focus:border-white transition-colors"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={user?.email || ''}
                      disabled
                      className="w-full bg-neutral-900 border border-neutral-800 rounded-xl pl-9 pr-4 py-2.5 text-text-muted text-sm cursor-not-allowed"
                    />
                  </div>
                </div>
                  ...
                  {editing ? (
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        rows={2}
                        className="input pl-9 pr-4 py-2.5 resize-none"
                  ...
                  <div>
                    ...
                    {editing ? (
                      <input
                        ...
                        className="w-full bg-neutral-900 border border-neutral-800 rounded-xl px-4 py-2.5 text-text-primary text-sm focus:outline-none focus:border-white transition-colors"
            ...
            <div className="card p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className={`text-xs font-bold uppercase tracking-wide px-2 py-0.5 rounded-full ${isAdmin ? 'bg-white/10 text-white' : 'bg-neutral-900 text-text-secondary'}`}>
