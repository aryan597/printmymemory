      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          ...
          <p className="text-text-secondary text-base sm:text-lg mb-10 max-w-xl mx-auto leading-relaxed">
            Send us your photo on WhatsApp and we'll craft a stunning 3D print, delivered to your door across India.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href={`https://wa.me/${WHATSAPP_NUMBER}?text=Hi! I want to create a personalized 3D gift.`}
              target="_blank"
              rel="noopener noreferrer"
              className="btn-green w-full sm:w-auto text-base py-4 px-8"
            >
              <WaIcon />
              Order on WhatsApp
              <ArrowRight size={16} />
            ...
            <Link
              to="/shop"
              className="btn-secondary w-full sm:w-auto text-base py-4 px-8"
            >
              Browse Products
              <ArrowRight size={16} />
            </Link>
