    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="announcement-bar bg-white text-black text-[11px] sm:text-xs py-2 px-4 relative"
          role="banner"
          aria-label="Announcement"
        >
          <div className="max-w-7xl mx-auto flex items-center justify-center gap-2">
            <Percent size={12} className="shrink-0" aria-hidden="true" />
            <span className="font-semibold tracking-wide">FLAT 10% OFF ON YOUR FIRST ORDER</span>
            <span className="hidden sm:inline text-black/60" aria-hidden="true">|</span>
